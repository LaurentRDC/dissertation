...
The identification of the transition to the $Cmcm$ phase as a consequence of strong and anisotropic electron-phonon interactions is important because the thermoelectric performance of tin selenide is maximized in the $Cmcm$ phase. Recall that by the definition of thermoelectric figure-of-merit from @eq:snse-zt, the thermoelectric conversion efficiency is higher for higher temperatures. However, the $Cmcm$ phase is a better thermoelectric even when factoring out the effect of temperature, as shown in @fig:snse-z.
