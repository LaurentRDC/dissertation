...
In quantum systems, the time scales associated with fundamental actions are determined by the energy scale around experimental temperature. Phonons populated at room temperature (\SI{300}{\kelvin}) might have a period shorter than \SI{1}{\pico\second} (\SI{1e-12}{\second}), as $\omega = k_B T / \hbar = \SI{25}{\milli\electronvolt} / \hbar = \SI{6}{\tera\hertz}$. 
