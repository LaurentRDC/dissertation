...
TODO: state that $g^{\lambda}_{ab}(\vect{k}_p, \vect{k}_e)$ is (scattering from state $a$ to $b$ ......)
...
TODO: describe the time-zero shift, which is the more critical effect of phase drift as the focus waist is long
